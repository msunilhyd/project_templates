...
app.use(bodyParser.urlencode({ limit: "30mb", extended: true}));
app.use(cors());

const CONNECTION_URL = 
CONNECTION_URL = 'mongodb+srv://newProjUser:linus@memprojectcluster.ecf9e.mongodb.net/memProjectDB?retryWrites=true&w=majority';
